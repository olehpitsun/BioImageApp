package sample.modules.controler;
...
import sample.modules.tools.Constants;
import sample.modules.tools.FilterUtil;
import sample.modules.tools.ImageOperations;
import sample.modules.tools.PSNR;
import sample.tools.*;
import sample.views.EditorView;
...
public class Controller {
    ...
    @FXML public void chooseFile(ActionEvent actionEvent) throws IOException {
    ...
    @FXML public void saveToFile()throws IOException {
        Highgui.imwrite( this.originalImagePath, this.image );
        System.out.println("Saving");
    }

    @FXML public void SaveAsNewFile() throws IOException {
