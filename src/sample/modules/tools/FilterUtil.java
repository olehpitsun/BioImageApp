...
import sample.modules.Filters.Filter;
import sample.modules.Filters.Operations;
import sample.tools.InputHandler;
import java.lang.*;
import java.util.LinkedHashMap;
import java.util.Map;
import sample.modules.tools.Error;
...
public class FilterUtil {
    ...
    private static sample.modules.controler.Controller controller;
    ...
    public static void buildParamBilateral() {
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                java.lang.Error er = n.checkBilateral(tfBilateralDiameter.getText(), tfSigmaColor.getText(), tfSigmaSpace.getText());
    ...
    public static void buildParamAdBilateral(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkAdaptive(tfSize.getText(), tfSigmaSpace.getText());
    ...
    public static void buildParamBlur(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkBlur(tfSize.getText());
    ...
    public static void buildParamGaussian(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkGaussian(tfSize.getText(), tfSigmaX.getText());
    ...
    public static void buildParamMedianBlur(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkMedian(tfSize.getText());
    ...
    public static void buildParamLaplacian() {
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkLaplacian(tfSize.getText(), tfScale.getText(), tfDelta.getText());
    ...
    public static void buildParamSobel() {
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkSobel(tfDx.getText(), tfDy.getText(), tfSize.getText());
    ...
    public static void buildParamErode(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkErodeDilate(tfErode.getText());
    ...
    public static void buildParamDilate(){
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkErodeDilate(tfDilate.getText());
    ...
    public static void buildParamContrast() {
        ...
        btApply.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                InputHandler n = new InputHandler();
                java.lang.Error er = n.checkContrast(tfAlpha.getText());
    ...
    public static void setController(sample.modules.controler.Controller c){
        controller = c;
