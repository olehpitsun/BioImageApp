...
public final class PSNR {
    ...
    public static float getmeanSquaredError(BufferedImage image1, BufferedImage image2){
        ...
        return (totalRed + totalGreen + totalBlue) / (image1.getWidth() * image1.getHeight() * 3);
    }
